...
class MlController(object):
    ...
    def evaluate(self, features, labels=None, feature_id_col_name=None, metadata_col_names=[]):
    ...
    def predict(self, features, labels=None, feature_id_col_name=None, metadata_col_names=[]):
    ...
    def predict_class_probabilities(self, features, labels=None, feature_id_col_name=None, metadata_col_names=[]):
    ...
    def classify_by_links_probability(self, features, labels=None, feature_id_col_name=None, metadata_col_names=[],
