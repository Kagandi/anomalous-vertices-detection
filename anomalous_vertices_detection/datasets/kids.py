...
def load_data(dataset_file_name="twitter.csv.gz", labels_file_name="twitter_fake_ids", labels_map=None):
    ...
    return GraphFactory().factory(twitter_config, labels=labels_map), twitter_config
